                ...
                <div className="space-y-10 text-lg leading-snug text-foreground/90">
                    ...
                    <FadeInSection>
                        ...
                        <ul className="space-y-0">
                            ...
                            <li className="flex gap-3">
                                <span className="text-primary/60 text-xs mt-[6px] shrink-0">○</span>
                                <span><a href="https://www.avabear.xyz/p/the-friendship-theory-of-everything" target="_blank" rel="noopener noreferrer" className="underline decoration-primary/30 hover:decoration-primary transition-colors underline-offset-4">The friendship theory of everything</a></span>
                            </li>
                        </ul>
                    </FadeInSection>
                </div>
